...
const TeamArray = [
  ...
  { id: 4, name: 'Diego Cáceres', role: 'Tech Lead', image: require('../../images/team/team-d-caceres.png') },
  { id: 5, name: 'Federico Sobral', role: 'Tech Lead', image: require('../../images/team/team-f-sobral.png') },
  { id: 8, name: 'Natalia Calle', role: 'Mobile Developer', image: require('../../images/team/team-n-calle.png') },
  { id: 7, name: 'Matías Piñeiro', role: 'Web & Mobile Developer', image: require('../../images/team/team-m.pineiro.png') },
  { id: 80, name: 'Hiring' },
  ...
  { id: 10, name: 'Dayana Bakerdjian', role: 'Quality Asurance', image: require('../../images/team/team-d-b.png') },
  { id: 11, name: 'Luis Moreno', role: 'Quality Asurance', image: require('../../images/team/team-l-moreno.png') },
  { id: 21, name: 'Sofia Schoepf', role: 'Quality Asurance', image: require('../../images/team/team-f-sendra.png') },
  { id: 180, name: 'Hiring' }
